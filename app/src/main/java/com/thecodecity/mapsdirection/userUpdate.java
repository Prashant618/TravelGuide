...
public class userUpdate extends AppCompatActivity {
    EditText edUname,edPass,edEmail,edMob,edAdd;
    Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String name = userLogin.userdata;

                if(username.equals("")||passward.equals("")||email.equals("")||phone.equals("")||address.equals("")) {
                    Toast.makeText(userUpdate.this, "Please enter details.", Toast.LENGTH_SHORT).show();
                }
...
//                        String publisher = json_data.getString("publisher");
                        ...
                        if (bookName.equals("1")) {
                            ...
                            Intent io = new Intent(userUpdate.this, userLogin.class);
                            ...
                            Toast.makeText(userUpdate.this, "Wrong username or password", Toast.LENGTH_SHORT).show();
