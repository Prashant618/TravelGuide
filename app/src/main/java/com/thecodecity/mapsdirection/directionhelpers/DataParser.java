...
public class DataParser {
    public static double timerequired=0;
        ...
        try {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    ...
                    timerequired=(Double.parseDouble(jDuration.get("value").toString())/60);
                    totaldistance=(Double.parseDouble(jDistance.get("value").toString()));
