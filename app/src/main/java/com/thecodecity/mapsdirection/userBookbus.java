...
public class userBookbus extends AppCompatActivity {
    EditText Searchtext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_bookbus);
    ...
    private void fillExampleList() {
        ...
        String url = UrlLinks.loadbusinfo;
        ...
        try {
            ...
            request.put("hospitalname", "fortis");
            String result1 = "";
...
//                        json_data = jArray.getJSONObject(i);
            ...
            for (int k = 0; k < jArray.length(); k++) {
                ...
                String doctorname = json_data.getString("busnumber");
                String availability = json_data.getString("BusplateNumber");
                String operation = json_data.getString("Destination");
                String education = json_data.getString("UpTiming");
...
//                Bitmap bmp= loadImage.execute(stUrl);
                ...
                exampleList.add(new ExampleItem(doctorname,availability,operation,education));
    ...
    private void setUpRecyclerView() {
        ...
        this.adapter = new ExampleAdapter(exampleList,getApplicationContext());
...
//        getSupportActionBar().setTitle((CharSequence) "Filter Activity");
    ...
    public void filterQuery(String text) {
        ...
        for (ExampleItem s : exampleList) {
            if (s.getmText1().toLowerCase().contains(text) || s.getmText3().toLowerCase().contains(text)) {
                filterdNames.add(s);
            }
        }
